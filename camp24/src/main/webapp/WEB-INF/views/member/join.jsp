...
<link rel="stylesheet" type="text/css" href="/black/resources/css/user.css">
<link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">
<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Raleway">
<script type="text/javascript" src="/black/resources/js/jquery-3.6.0.min.js"></script>
<script type="text/javascript" src="/black/resources/js/whistle/login.js"></script>
<style type="text/css">
	.avtimg {
		width: 100px;
		height: 100px;
...
<div>
			<label for="repw" class="w3-col s3 w3-right-align clrgrey ft14 mgb10" >비밀번호 : </label>
				...
				<div class="w3-col s8 mgl10 mgb10">
					<input type="password" id="pwck" class="w3-col w3-input w3-border w3-margin-bottom" placeholder="내용을 입력해주세요">
				</div>
			</div>
			<div>
			...
			<div>
				...
				<label class="w3-col s3 w3-right-align clrgrey ft14 mgb10 w3-margin-top">아 바 타 : </label>
				<div class="w3-col s8 mgl10 mgb10 w3-center w3-margin-top">
		...
		<div class="w3-col w3-margin-top w3-card-4 w3-center mxw700">
			<div class="w3-col w3-gray w3-button" id="rbtn">회원가입</div> 
	</div>
</body>
</html>